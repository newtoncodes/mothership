...
cp -f ${dir}/registry.yml /var/lib/docker/volumes/registry_config/_data/config.yml
cp -f ${dir}/auth.ldap.yml /var/lib/docker/volumes/registry_auth_config/_data/auth.ldap.yml
cp -f ${dir}/auth.simple.yml /var/lib/docker/volumes/registry_auth_config/_data/auth.simple.yml
